...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   airBlower.mouseClicked(forceOfBlower);
   ...
   // star 2
   star2 = createSprite(50 , 370 , 10 , 20);
  ...
  star_display.addAnimation("1" , empty_star);
  star_display.addAnimation("2" , one_star);
  star_display.addAnimation("3" , two_star);
  star_display.changeAnimation("1");
...
function draw() 
{
  ...
  if(collision(fruit , star1 , 20)==true){
    star1.visible = false;
    star_display.changeAnimation("2");
  }
  if(collision(fruit , star2 , 20)==true){
    star2.visible = false ;
    star_display.changeAnimation("3");
  }
...
function forceOfBlower(){
  Body.applyForce(fruit , { x : 0 , y : 0 } , { x : 0 , y : -0.03 } );
  air.play();
};

function collision( body , sprite , xp ){
  if(body != null){
  var d = dist(body.position.x , body.position.y , sprite.position.x , sprite.position.y);
